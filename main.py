...
converted_values = {}
for key in other_currency_data: #iterate thru other currencies
    other_value = other_currency_data[key]["value"] #obtain exchange rate relative to base currency for current 'other currency'
    converted_values[key] = convert(base_value, other_value)#perform conversion

base_value = append_zero(str(base_value)) #check length of digits after decimal. 
                                          #its guaranteed the num of digits after decimal will not exceed 2
